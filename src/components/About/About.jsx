    ...
    <div>
      <div className="about m-auto p-12 md:p-24">
        ...
        <div className="about2 gap-8 m-auto flex flex-col-reverse md:flex-row  md:p-12">
          <p className="textt text-center md:text-left text-1xl md:text-2xl">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Nobis voluptas id perferendis recusandae? Sequi numquam quidem illum! Delectus quasi ipsam dolores ipsum vel cupiditate voluptatem veritatis, fuga, repellendus voluptatum reiciendis!
